...
// BASE URL এখানে ব্যবহার করছি, কারণ এটি API কলের জন্য প্রয়োজন।
// NOTE: আপনার কোডে 'lbracks' এবং 'ibracks' উভয় URL দেখা গেছে।
// একটি নির্দিষ্ট BASE_URL ব্যবহার করা ভালো। আমি 'lbracks' ব্যবহার করছি।
