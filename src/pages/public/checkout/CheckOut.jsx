      ...
      <div className="flex w-full max-w-6xl flex-col gap-8 rounded-2xl p-6 md:p-10 lg:flex-row">
            ...
            {cartItems.map((item) => (
              ...
              >
                ...
                <div className="flex flex-1 flex-col gap-1">
                  <div className="text-lg font-[600] text-[#3B3B3B] capitalize">
                    {item.name}
                  </div>
                  <div className="text-base font-[400] text-neutral-700 capitalize">
                    {item.genre}
                  </div>
                </div>
        ...
        <div className="flex w-full flex-col gap-4 rounded-[20px] bg-white/30 p-4 lg:w-96">
          <div className="flex items-center justify-between">
            <h2 className="text-[22px] font-[600] text-white">Card Details</h2>
            <img
          ...
          <div className="gap-2">
            ...
            <div className="top-0 bottom-0 flex items-center justify-between py-2">
              <span className="text-sm font-[500] text-white">Shipping</span>
              <span className="text-sm font-[500] text-white">
                ${shipping.toFixed(2)}
              </span>
            </div>
